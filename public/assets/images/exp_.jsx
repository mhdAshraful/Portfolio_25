...
>
	<g id="exp_drawer">
		...
		<g id="exp_5_hide">
			...
			<g id="Role: Providing service and operational support in a customer-facing retail environment. Played a key role in maintaining inventory flow and product quality.">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
				...
				>
					<tspan x="179.328" y="697.994">
						{" "}
						Providing service and operational support in a customer-facing
						retail{" "}
					</tspan>
					<tspan x="143" y="716.994">
						environment. Played a key role in maintaining inventory flow
						and product quality.
					</tspan>
				</text>
				<text
			...
			>
				<tspan x="179" y="760.734">
					Assisted customers with product inquiries and checkout
					experiences&#10;
				</tspan>
			...
			<g id="Start: May 2020, End: Jul 2022">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
			...
			<rect
				...
				fill="#0F0F0F"
			/>
			<g id="Location: Darwin, NT Australia">
				<text
					fill="#FFFFF1"
					xml:space="preserve"
					style="white-space: pre"
		...
		<g id="exp_4_hide">
			...
			<g id="Role: Built custom PC systems and supported day-to-day retail operations in a fast-paced IT hardware store.">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
				...
				>
					<tspan x="170.215" y="745.04">
						{" "}
						Built custom PC systems and supported day-to-day retail
						operations in a fast-
					</tspan>
			...
			>
				...
				<tspan x="169.212" y="834.609">
					Managed incoming stock, handled dispatches, and updated inventory
					records&#10;
				</tspan>
				<tspan x="169.212" y="853.609">
					Provided technical advice and support to walk-in and phone
					customers&#10;
				</tspan>
				<tspan x="169.212" y="872.609">
					Processed transactions and orders while maintaining a high level
					of customer{" "}
				</tspan>
			...
			<g id="Start: Feb 2018, End: Jun 2018">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
			...
			<rect
				...
				fill="#0F0F0F"
			/>
			<g id="Location: Woolner, NT Australia">
				<text
					fill="#FFFFF1"
					xml:space="preserve"
					style="white-space: pre"
			...
			<g id="cpu" clip-path="url(#clip0_1271_984)">
				<path
					id="Vector_6"
		...
		<g id="exp_3_hide">
			...
			<g id="Role: Provided on-site technical support and network setup for businesses, addressing a wide range of hardware and software issues with professionalism and precision.">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
				...
				>
					<tspan x="162.034" y="843.155">
						{" "}
						Provided on-site technical support and network setup for
						businesses, addressing a{" "}
					</tspan>
			...
			>
				<tspan x="162.17" y="919.818">
					Diagnosed and resolved IT issues across hardware, software, and
					networking{" "}
				</tspan>
				...
				<tspan x="162.17" y="957.818">
					Installed and configured operating systems, peripherals, and
					network equipment&#10;
				</tspan>
				<tspan x="162.17" y="976.818">
					Maintained accurate documentation of support tickets, inventory,
					and resolutions&#10;
				</tspan>
				<tspan x="162.17" y="995.818">
					Performed preventive maintenance and safety checks during field
					visits&#10;
				</tspan>
				<tspan x="162.17" y="1014.82">
					Assisted clients with technical inquiries and provided training
					for basic system use
				</tspan>
			</text>
			<text
				id="Tools:_2"
			...
			<g id="Start: Mar 2023, End: Current">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
			...
			<rect
				...
				fill="#0F0F0F"
			/>
			<g id="Location: Darwin, NT Australia_2">
				<text
					fill="#FFFFF1"
					xml:space="preserve"
					style="white-space: pre"
			...
			<g id="Org: Best Technology Services">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
		...
		<g id="exp_2_hide">
			...
			<g id="Role: Contributed to several end-to-end web development projects during a comprehensive internship. Gained exposure to user research, design systems, testing, and deployment within a collaborative team environment.">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
				...
				>
					<tspan x="160.293" y="907.094">
						{" "}
						Contributed to several end-to-end web development projects
						during a{" "}
					</tspan>
					<tspan x="123.965" y="926.094">
						comprehensive internship. Gained exposure to user research,
						design systems, testing, and{" "}
					</tspan>
			...
			>
				...
				<tspan x="162.671" y="1027.15">
					Created wireframes, UI mockups, and prototypes for developer
					handoff&#10;
				</tspan>
				<tspan x="162.671" y="1046.15">
					Assisted in testing web apps with end-users and integrated
					feedback into iterative{" "}
				</tspan>
				<tspan x="162.671" y="1065.15">
					design improvements&#10;
				</tspan>
				<tspan x="162.671" y="1084.15">
					Participated in project meetings, presented design concepts, and
					addressed client{" "}
				</tspan>
				...
				<tspan x="162.671" y="1122.15">
					Documented development processes and ensured compliance with WHS
					policies{" "}
				</tspan>
			...
			<g id="Start: Nov 2020, End: Apr 2021">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
			...
			<rect
				...
				fill="#0F0F0F"
			/>
			<g id="Location: Darwin, NT Australia_3">
				<text
					fill="#FFFFF1"
					xml:space="preserve"
					style="white-space: pre"
			...
			<g id="Org: Charles Darwin University, Dep. of Health &#38; Research">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
				...
				>
					...
					<tspan x="307.911" y="825.401">
						{" "}
						Charles Darwin University, Dep. of Health &#38; Research
					</tspan>
				</text>
			</g>
			<path
				...
				fill="black"
			/>
			<g id="CSS Document Icon 1" clip-path="url(#clip1_1271_984)">
				<g id="Group">
					<path
						id="Vector_11"
		...
		<g id="exp_1_hide">
			...
			<g id="Role: Build custom websites and revamp existing platforms with a focus on responsive design, accessibility, and scalable architecture. Worked closely with designers and clients to align functionality with user experience.">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"
				...
				>
					<tspan x="149.328" y="1015.19">
						{" "}
						Build custom websites and revamp existing platforms with a
						focus on responsive{" "}
					</tspan>
					<tspan x="113" y="1034.19">
						design, accessibility, and scalable architecture. Worked
						closely with designers and clients to{" "}
					</tspan>
			...
			>
				<tspan x="153" y="1097.25">
					{" "}
					Transformed static designs into dynamic, mobile-friendly web
				...
				<tspan x="153" y="1135.25">
					Collaborated with UX designers to iterate on user flows and
					design implementation&#34;,&#10;
				</tspan>
				<tspan x="153" y="1154.25">
					Communicated directly with clients to gather requirements, set
					expectations, and{" "}
				</tspan>
				...
				<tspan x="153" y="1192.25">
					Implemented React Context API to manage global state and simplify
					component{" "}
				</tspan>
				...
				<tspan x="153" y="1230.25">
					Optimized SEO through structured data, clean markup, and
					performance{" "}
				</tspan>
			...
			<g id="Start: Mar 2023, End: Current_2">
				<text
					fill="black"
					xml:space="preserve"
					style="white-space: pre"

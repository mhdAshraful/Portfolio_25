	...
	},
	{
		experiences: [
			// Recent client work (update dates as needed)
			{
				...
				role: "Currently working on building an e-commerce Storefront & Dashboard for this client using Next.js 15 (App Router) and TypeScript. Owned UI architecture, responsive catalog experiences, and checkout/payment integration.",
				achievements: [
			...
			},
			{
				...
				role: "Worked on building an e-commerce Storefront & Dashboard for this client using Next.js 15 (App Router) and TypeScript. Owned UI architecture, responsive catalog experiences, and checkout/payment integration.",
				achievements: [
					"Develop and optimize scalable applications using modern frameworks",
					"Ensure code quality, security, and performance through code review",
					"Integrate CI/CD pipeline for continuous deployment and automation",
					"Collaborate with cross-functional teams (i.e. DevOps, Network Engineers, Designers)",
				],
			...
			},
			{
				...
				role: "Built case study websites and portfolios for clients. Also I took this time as opportunity to learn new technologies and frameworks from Awwwards, Frontend Masters and other web development resources. Implemented responsive design, accessibility, and scalable architecture. Worked closely with designers and clients to align functionality with user experience.",
				achievements: [

			...
			<div className="experiences" ref={expRef}>
				...
				>
					...
					>
						...
						<g id="exp_5_hide" onClick={(e) => hiding(e)}>
							<path
								id="Vector 9"
						...
						<g id="exp_5" onClick={(e) => seeking(e)}>
							<path
								id="Vector 26"
						...
						<g id="exp_4_hide" onClick={(e) => hiding(e)}>
							<path
								id="Vector 9_2"
						...
						<g id="exp_4" onClick={(e) => seeking(e)}>
							<path
								id="Vector 30"
						...
						<g id="exp_3_hide" onClick={(e) => hiding(e)}>
							<path
								id="Vector 9_3"
						...
						<g id="exp_3" onClick={(e) => seeking(e)}>
							<path
								id="Vector 22"
						...
						<g id="exp_2_hide" onClick={(e) => hiding(e)}>
							<path
								id="Vector 9_4"
						...
						<g id="exp_2" onClick={(e) => seeking(e)}>
							<path
								id="Vector 19"
						...
						<g id="exp_1_hide" onClick={(e) => hiding(e)}>
							<path
								id="Vector 9_5"
						...
						<g id="exp_1" onClick={(e) => seeking(e)}>
							<path
								id="Vector 9_6"
